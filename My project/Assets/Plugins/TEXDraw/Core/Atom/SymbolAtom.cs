...
namespace TexDrawLib
{
    public class AutoDelimitedGroupAtom : InlineAtom
    {
        ...
        public override CharType LeftType => left?.Type ?? Type;
        public override CharType RightType => right?.Type ?? Type;
        ...
        public override Box CreateBox(TexBoxingState state)
        {
            ...
            if (leftBox != null)
            {
                ...
                var gluel = translateGlueCode(TEXPreference.main.GetGlue(left.RightType, atom.LeftType));
                if (gluel > 0)
            ...
            if (rightBox != null)
            {
                ...
                var gluer = translateGlueCode(TEXPreference.main.GetGlue(atom.RightType, right.LeftType));
                if (gluer > 0)
